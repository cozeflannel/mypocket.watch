...
import { Zap, Calendar, DollarSign, Users, ChevronDown, Menu, X, Clock, HelpCircle, Link2, ChevronsLeft, ChevronsRight } from 'lucide-react';
...
export function Sidebar() {
  ...
  return (
    <>
      ...
      <aside
        className={cn(
          'fixed inset-y-0 left-0 z-40 flex flex-col border-r border-gray-200 bg-white transition-all duration-200 dark:border-gray-800 dark:bg-gray-950 lg:static',
          collapsed ? 'w-16' : 'w-64',
